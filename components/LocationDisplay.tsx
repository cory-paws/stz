            ...
            <div className="flex flex-col lg:flex-row gap-16">
                {data.image && (
                    <div className="lg:w-1/2 flex-shrink-0">
                        <div className="w-full max-h-[700px] overflow-hidden rounded-3xl border-2 border-green-500/20 shadow-[0_0_50px_rgba(0,0,0,0.8)] relative bg-[#050a05] after:absolute after:inset-0 after:bg-gradient-to-b after:from-transparent after:from-70% after:to-[#050a05]/60 after:pointer-events-none lg:sticky lg:top-8">
                            <img
                                src={data.image}
                                alt={data.title}
